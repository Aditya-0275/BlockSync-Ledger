class TransactionPool:
    ...
    def existing_transaction(self, address):
        """
        Helps find a transaction generated by the address in the transaction pool.
        """
    ...
    def transaction_data(self):
        """
        Return the transaction from the transactions pool represented in their json serialised form.
        """
        return list(map(
